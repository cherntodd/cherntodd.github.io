...
<ol>
    <li value="4">Nonparametric Adaptive Bayesian Stochastic Control Under Model Uncertainty (with Jiyoun Myung) Preprint (27 pages), 2020. <a href="https://arxiv.org/abs/2011.04804">arXiv</a>, <a href="http://taochen.im/files/AdaptiveBayesian.pdf">PDF</a></li>
	<li value="4">Time-Inconsistent Markovian Control Problems under Model Uncertainty with Application to the Mean-Variance Portfolio Selection (with Tomasz R. Bielecki and Igor Cialenco) Preprint (24 pages), 2020. <a href="https://arxiv.org/abs/2002.02604">arXiv</a>, <a href="http://taochen.im/files/Time-Inconsistent.pdf">PDF</a></li>
